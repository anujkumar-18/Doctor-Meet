...
const Header = async () => {
  ...
  if (user?.role === "PATIENT" ) { 
     await checkAndlocateCredits(user)
  }

  return (
    <header className="fixed top-0 w-full border bg-background/80 backdrop-blur-md z-10 supports-[backdrop-filter]:bg-background/60">
