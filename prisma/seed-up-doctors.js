...
async function main() {
  ...
  const upDoctors = [
    ...
    {
      clerkUserId: "dr_up_kanpur_cardio",
      name: "Dr. Pramod Tandon",
      email: "pramod.tandon@doctorsmeet.in",
      imageUrl: "https://images.unsplash.com/photo-1559839734-2b71f1536783?q=80&w=200&h=200&auto=format&fit=crop",
      role: "DOCTOR",
      specialty: "Cardiology",
      experience: 18,
      description: "Interventional Cardiologist at Aryan Hospital, Kanpur. Expert in ECG, Echocardiography, and Heart Failure management for over 18 years.",
      location: "Kanpur",
      phone: "9335028745",
      verificationStatus: "VERIFIED",
    },
    {
      clerkUserId: "dr_up_kanpur_ortho",
      name: "Dr. Ramesh Gupta",
      email: "ramesh.gupta.kanpur@doctorsmeet.in",
      imageUrl: "https://images.unsplash.com/photo-1622902046580-2b47f47f0871?q=80&w=200&h=200&auto=format&fit=crop",
      role: "DOCTOR",
      specialty: "Orthopedics",
      experience: 16,
      description: "Senior Orthopedic Surgeon at Navyug Hospital, Kidwai Nagar, Kanpur. Specializes in knee & hip replacements, spine surgery, and fracture care.",
      location: "Kanpur",
      phone: "9918714520",
      verificationStatus: "VERIFIED",
    },
    {
      clerkUserId: "dr_up_kanpur_gyne",
      name: "Dr. Rekha Bajpai",
      email: "rekha.bajpai@doctorsmeet.in",
      imageUrl: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?q=80&w=200&h=200&auto=format&fit=crop",
      role: "DOCTOR",
      specialty: "Obstetrics & Gynecology",
      experience: 22,
      description: "Senior Lady Gynecologist at Ratan Lal Nagar, Kanpur. Expert in normal & C-section deliveries, PCOS, infertility treatment, and laparoscopic surgery.",
      location: "Kanpur",
      phone: "9839456210",
      verificationStatus: "VERIFIED",
    },
    {
      clerkUserId: "dr_up_kanpur_derm",
      name: "Dr. Sanjeev Agarwal",
      email: "sanjeev.agarwal.kanpur@doctorsmeet.in",
      imageUrl: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?q=80&w=200&h=200&auto=format&fit=crop",
      role: "DOCTOR",
      specialty: "Dermatology",
      experience: 13,
      description: "Consultant Dermatologist in Govind Nagar, Kanpur. Specializes in skin infections, vitiligo treatment, hair transplant, and cosmetic dermatology.",
      location: "Kanpur",
      phone: "9415022378",
      verificationStatus: "VERIFIED",
    },
    {
      clerkUserId: "dr_up_kanpur_peds",
      name: "Dr. Neeraj Sood",
      email: "neeraj.sood@doctorsmeet.in",
      imageUrl: "https://images.unsplash.com/photo-1582750433449-648ed127bb54?q=80&w=200&h=200&auto=format&fit=crop",
      role: "DOCTOR",
      specialty: "Pediatrics",
      experience: 14,
      description: "Renowned Child Specialist & Neonatologist in Civil Lines, Kanpur. Expert in childhood vaccines, fever management, newborn care, and developmental disorders.",
      location: "Kanpur",
      phone: "9336074512",
      verificationStatus: "VERIFIED",
    },
