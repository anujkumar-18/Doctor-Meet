...
import { updateDoctorStatus } from "@/components/actions/admin";
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle, DialogTrigger } from "@/components/ui/dialog";
import useFetch from "@/hooks/use-fetch";
import { Separator } from "@/components/ui/separator"; // fixed from @radix-ui/react-select probably
import { format, formatDate } from "date-fns";
import { Badge, ExternalLink, FileText, Medal, User } from "lucide-react";
    ...
    return (
        <div>
            <Card className="bg-muted/20 border-emerald-900/20">
                <CardHeader>
                    <CardTitle className="text-xl font-bold text-white">Pending Doctor Verification</CardTitle>
                            ...
                            <div className="space-y-6 py-4">
                                ...
                                <div className="flex flex-col md:flex-row gap-6">
                                    ...
                                    <div className="space-y-1 flex-1">
                                        ...
                                        <p className="text-base font-medium text-white">
                                            {selectedDoctor.createdAt ? format(new Date(selectedDoctor.createdAt), "PPP") : "N/A"}
                                        </p>
                                    </div>
                                </div>
