   ...
   <div className="bg-background">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">Connect with doctors <br />
             ...
             <p className="text-muted-foreground text-lg md:text-xl max-w-md"> 
              Book appointments, access medical records, and get expert advice from the comfort of your home.
             </p>
    ...
    <div className="container mx-auto px-4">
      <div className="text-center mb-16">
       ...
       <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
        Our platform connects you with verified healthcare professionals for seamless online consultations. Here's how it works in simple steps:
       </p>
      </div>
    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Choose from a variety of consultation packages tailored to your healthcare needs.</p>
       </div>
       <div>
        {/* Pricing Table */}
        <PricingTable />
        <Card className="mt-12 bg-muted/20 border-emerald-400">
          <CardHeader>
            ...
            <ul className="space-y-3">
              {creditBenefits.map((benefit, index) => {
                ...
                <li key={index} className="flex items-start">
                  <div className="me-3 mt-1 bg-emerald-900/20 p-1 rounded-full">
    ...
    <div className="container mx-auto px-4">
      <div className="text-center mb-16">
       ...
       <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
        Hear from patients and doctor who have experienced the benefits of our platform.
       </p>
      </div>
